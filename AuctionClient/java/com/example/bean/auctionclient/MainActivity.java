...
public class MainActivity extends FragmentActivity
{
    ...
    private void InitViewPager()
    {
        ...
        Intent intent = new Intent(MainActivity.this, ManageKind.class);
        list.add(getView("A", intent));
        Intent intent2 = new Intent(MainActivity.this, ManageItem.class);
        list.add(getView("B", intent2));
        Intent intent3 = new Intent(MainActivity.this, ChooseKind.class);
        ...
        public void onPageSelected(int arg0)
        {
            ...
            switch (arg0)
            {
                case 0:
                    ...
                    tvTabActivity.setTextColor(resources.getColor(R.color.red));
                    break;
                case 1:
                    if (currIndex == 0)
                    {
                    ...
                    tvTabGroups.setTextColor(resources.getColor(R.color.red));
                    break;
                case 2:
                    if (currIndex == 0)
                    {
                    ...
                    tvTabFriends.setTextColor(resources.getColor(R.color.red));
                    break;
            }
            currIndex = arg0;
