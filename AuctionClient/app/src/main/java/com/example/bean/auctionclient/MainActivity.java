        ...
        mainMenu.setOnItemClickListener(new OnItemClickListener()
        {
                                    ...
                                    int position, long id)
            {
                ...
                switch ((int) id)
                {
                    ...
                    case 0:
                        // 启动ViewItem Activity
                        intent = new Intent(MainActivity.this, ViewItem.class);
                    ...
                    case 2:
                        ...
                        intent = new Intent(MainActivity.this, ManageKind.class);
                        startActivity(intent);
                        break;
                    // 管理物品
                    case 3:
                        // 启动ManageItem Activity
                        intent = new Intent(MainActivity.this, ManageItem.class);
                        startActivity(intent);
                        break;
                    // 浏览拍卖物品（选择物品种类）
                    case 4:
                        // 启动ChooseKind Activity
                        intent = new Intent(MainActivity.this, ChooseKind.class);
                        startActivity(intent);
                        break;
                    // 查看自己的竞标
                    case 5:
                        // 启动ViewBid Activity
                        intent = new Intent(MainActivity.this, ViewBid.class);
                        startActivity(intent);
                        break;
                }
            }
